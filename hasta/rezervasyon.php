                        ...
                        <tbody>
                            ...
                            if(($_GET)){
                                ...
                                if(isset($_GET["id"])){
                                    ...
                                    $sqlmain= "select * from takvim inner join doktor on takvim.docid=doktor.docid where takvim.scheduleid=$id  order by takvim.scheduledate desc";
                                    ...
                                    $sql2="select * from randevu where scheduleid=$id";
                                    //echo $sql2;
                                     $result12= $database->query($sql2);
                                     $apponum=($result12->num_rows)+1;
                                    
                                    echo '
                                        <form action="rezervasyon-tamamla.php" method="post">
                                    ...
                                    <td style="width: 50%;" rowspan="2">
                                            <div  class="dashboard-items search-items"  >
                                                ...
                                                <div style="width:100%">
                                                        ...
                                                        <div class="h3-search" style="font-size:18px;line-height:30px">
                                                            Doktor adı:  &nbsp;&nbsp;<b>'.$docname.'</b><br>
                                                            Doktor e-posta adresi:  &nbsp;&nbsp;<b>'.$docemail.'</b> 
                                                        </div>
                                                        <div class="h3-search" style="font-size:18px;">
                                                          
                                                        </div><br>
                                                        <div class="h3-search" style="font-size:18px;">
                                                            Oturum başlığı: '.$title.'<br>
                                                            Planlanan oturum tarihi: '.$scheduledate.'<br>
                                                            Oturum başlangıcı : '.$scheduletime.'<br>
                                        ...
                                        <tr>
                                            <td>
                                                <input type="Submit" class="login-btn btn-primary btn btn-book" style="margin-left:10px;padding-left: 25px;padding-right: 25px;padding-top: 10px;padding-bottom: 10px;width:95%;text-align: center;" value="Randevu Al" name="booknow"></button>
                                            </form>
                                            </td>
                                        </tr>
                                        '; 
