            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                        ...
                        <tr >
                            ...
                            <td width="15%">
                                ...
                                $appointmentrow = $database->query("SELECT * FROM randevu WHERE docid = $userid AND appodate = CURDATE() AND rndurum = 1;");
                                $schedulerow = $database->query("SELECT * FROM takvim WHERE docid = $userid AND durum = 1");
                ...
                <tr>
                    ...
                    <tr>
                        <td >
                            ...
                            <a href="randevu.php" class="non-style-link"><button class="btn-primary btn" style="width:30%">Randevularımı görüntüle</button></a>
                            <br>
                            <br>
                        </td>
                    </tr>
                        ...
                        <table border="0" width="100%"">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p id="anim" style="font-size: 20px;font-weight:600;padding-left: 40px;">Gelecek Haftaya Kadar Yaklaşan Seanslarınız</p>
                                    <center>
                                        ...
                                        <tbody>
                                            ...
                                            $sqlmain= "SELECT r.appodate, h.pname, t.title,r.rndtime
                                            FROM randevu r
                                            INNER JOIN takvim t ON r.scheduleid = t.scheduleid
                                            INNER JOIN hasta h ON r.pid = h.pid
                                            WHERE t.docid = $userid
                                            AND r.appodate BETWEEN CURDATE() AND DATE_ADD(CURDATE(), INTERVAL 1 WEEK)
                                            AND r.rndurum = 1
                                            ORDER BY r.appodate ASC;
                                            ";
                                                ...
                                                for ( $x=0; $x<$result->num_rows;$x++){
                                                    ...
                                                    echo '<tr>
                                                        ...
                                                        substr($hastaad,0,30)
                                                        .'</td>
                                                        <td style="font-size:25px;text-align:center;font-weight:bold;">
                                                        '.substr($title,0,10).'
                                                        </td>
                                                        <td style="text-align:center;">
                                                        '.substr($tarih,0,10).' ' .' '.substr($time,0,5).'
                                                        </td>
