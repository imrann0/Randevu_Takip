        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td>
                        <p style="font-size: 23px;padding-left:12px;font-weight: 600;">Reddelilen Randevular</p>
                                ...
                                for ($x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr >
                                       ...
                                       &nbsp;&nbsp;&nbsp;
                                        ...
                                        if($durum == 2)
                                        {
                                            echo '<span style="color:red; text-align:center;">İptal Edildi</span>';
                                        }
                                        else
                                        {
